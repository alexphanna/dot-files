...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_ivory, col_black, col_black },
	[SchemeSel]  = { col_ivory, col_black, col_black },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_black, "-nf", col_ivory, "-sb", col_black, "-sf", col_ivory, NULL };
